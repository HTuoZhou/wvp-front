      ...
      <div class="container-login100">
        <div class="wrap-login100">
          ...
          <div class="wrap-input100 validate-input" data-validate="Valid email is: a@b.c">
            <input v-model="username" :class="'input100 ' + (username==''?'':'has-val')" name="username" type="text">
          ...
          <div class="wrap-input100 validate-input" data-validate="Enter password">
            ...
            <input v-model="password" :class="'input100 ' + (password==''?'':'has-val')"
                   :type="(!showPassword?'password':'text')" name="password">
            <span class="focus-input100" data-placeholder="密码"></span>
          </div>

          <div class="container-login100-form-btn">
            <div v-loading="isLoging" :class="{'login-loading': isLoging}" class="wrap-login100-form-btn"
