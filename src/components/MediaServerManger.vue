  ...
  <div id="mediaServerManger" style="width: 100%">
    <div class="page-header">
      ...
      <div class="page-header-btn">
        <el-button icon="el-icon-plus" size="mini" style="margin-right: 1rem;" type="primary" @click="add">添加节点
        </el-button>
      </div>
    </div>

    <el-row :gutter="12">
      <el-col v-for="item in mediaServerList" :key="item.id" :span="num">
        <el-card :body-style="{ padding: '0px'}" class="server-card" shadow="hover">
          ...
          <div style="padding: 14px;text-align: left">
            ...
            <el-button v-if="!item.defaultServer" icon="el-icon-delete"
                       style="margin-right: 10px;padding: 0;float: right;" type="text" @click="del(item)">移除
            </el-button>
