      ...
      <div id="shared" style="margin-top: 1rem;margin-right: 100px;">
        <el-form ref="streamProxy" :model="proxyParam" :rules="rules" label-width="140px">
          ...
          <el-form-item label="流应用名" prop="app">
            <el-input v-model="proxyParam.app" :disabled="edit" clearable></el-input>
          </el-form-item>
          <el-form-item label="流ID" prop="stream">
            <el-input v-model="proxyParam.stream" :disabled="edit" clearable></el-input>
          </el-form-item>
          ...
          <el-form-item v-if="proxyParam.gbId" label="经度" prop="longitude">
            <el-input v-model="proxyParam.longitude" clearable placeholder="经度"></el-input>
          </el-form-item>
          <el-form-item v-if="proxyParam.gbId" label="纬度" prop="latitude">
            <el-input v-model="proxyParam.latitude" clearable placeholder="经度"></el-input>
          </el-form-item>
          <el-form-item>
