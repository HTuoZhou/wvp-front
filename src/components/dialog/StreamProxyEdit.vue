    ...
    >
      <div id="shared" style="margin-top: 1rem;margin-right: 100px;">
        <el-form ref="streamProxy" :model="proxyParam" :rules="rules" label-width="140px">
          ...
          <el-form-item v-if="proxyParam.type=='default'" label="拉流地址" prop="url">
            <el-input v-model="proxyParam.url" clearable></el-input>
          </el-form-item>
          <el-form-item v-if="proxyParam.type=='ffmpeg'" label="拉流地址" prop="srcUrl">
            <el-input v-model="proxyParam.srcUrl" clearable></el-input>
          </el-form-item>
          <el-form-item v-if="proxyParam.type=='ffmpeg'" label="超时时间:毫秒" prop="timeoutMs">
          ...
          <el-form-item label="国标编码" prop="gbId">
            <el-input v-model="proxyParam.gbId" clearable placeholder="设置国标编码可推送到国标"></el-input>
          </el-form-item>
          ...
          <el-form-item label="其他选项">
            <div style="float: left;">
              <el-checkbox v-model="proxyParam.enable" label="启用"></el-checkbox>
              <el-checkbox v-model="proxyParam.enableAudio" label="开启音频"></el-checkbox>
              <el-checkbox v-model="proxyParam.enableMp4" label="录制"></el-checkbox>
            </div>

          </el-form-item>
          <el-form-item>
            <div style="float: right;">
              <el-button :loading="dialogLoading" type="primary" @click="onSubmit">{{ onSubmit_text }}</el-button>
